...
namespace pocketmine {
	...
	const VERSION = "1.1DEV-PTK";
	const API_VERSION = "2.0.0";
	const CODENAME = "PTK-KienPham";
	const MINECRAFT_VERSION = "v0.14.x";
	const MINECRAFT_VERSION_NETWORK = "696969";
	...
	if(!ini_get("date.timezone")){
		if(($timezone = "Asia/Ho_Chi_Minh") and date_default_timezone_set($timezone)){
