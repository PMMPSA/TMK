...
class MainLogger extends \AttachableThreadedLogger {
	 ...
	 * @param string $name
	 */
	public function emergency($message, $name = "TRƯỜNG HỢP KHẨN CẤP"){
	...
	protected function send($message, $level, $prefix, $color){
		...
		if($thread === null){
			$threadName = "§b§cT§aᗰ§6K§6NetWork";
		...
		//$message = TextFormat::toANSI(TextFormat::AQUA . "[§cT§aᗰ§6K]->[" . date("H:i:s", $now) . "] " . TextFormat::RESET . $color . "[$prefix]:" . " " . $message . TextFormat::RESET);
